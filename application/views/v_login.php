...
<head>
    ...
    <meta name="Team Labor Omega" content="">
							...
							<div class="col-lg-12">
								<div class="p-5">
									<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Silakan Login Untuk Mengakses Web ini!</h1>
									</div>
									<form class="user" action="<?= base_url('login'); ?>" method="POST">
											...
											<!-- <a href="<?= base_url('/dashboard')?>" class="btn btn-success btn-user btn-block" >Login</a> -->
									</form>
									<hr>
								</div>
							</div>
